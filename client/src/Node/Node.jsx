...
const Node = (props) => {
    ...
    if (
        ...
        return (
            <Alert variant="danger">
                ...
                <meta
                    property="og:title"
                    content={`Crowdventure! - ${node.title}`}
                />
    ...
    if (
        ...
        return (
            <Alert variant="danger">
                ...
                <p>
                    This page has been hidden from general users, because the
                    author has been flagged as unsafe for the general public. If
                    you would like to see it, log in and turn on{" "}
                    <b>Unsafe mode</b>!
                </p>
            </Alert>
        );
    ...
    return (
        <Container>
            ...
            <h1 className="display-4 text-center">{node.title}</h1>
            {node.pictureURL ? (
                <>
            ...
            >
                <div className="col">
                    <h3 className="text-muted">Choices:</h3>
                </div>
            ...
            <Container className="row" style={{ paddingRight: "0px" }}>
                <div className="col align-bottom">
                    <h3 className="align-bottom text-muted">Other options:</h3>
                </div>
                <div className="col text-right" style={{ paddingRight: "0px" }}>
