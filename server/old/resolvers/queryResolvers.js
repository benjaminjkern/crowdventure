...
module.exports = {
    ...
    featuredNodes: async (parent, args) =>
        scramble(await databaseCalls.filterFeatured(args.allowHidden)).slice(
            0,
            args.count || 10
        ),
    recentlyUpdatedNodes: async (parent, args) =>
        await databaseCalls
            .sortedNodes(
    ...
    getNode: async (parent, args) => await databaseCalls.getNode(args.ID),
    getChoice: async (parent, args) => await databaseCalls.getChoice(args.ID),
    searchAccounts: async (parent, args) => {
