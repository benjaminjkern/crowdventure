                        ...
                        >
                            ...
                            {node.hidden ? (
                                <OverlayTrigger
                                    overlay={
                                        <Tooltip>
                                            This page is hidden, because it has
                                            been marked as unsafe! You can see
                                            it because you are{" "}
                                            {loggedInAs && loggedInAs.unsafeMode
                                                ? "in Unsafe Mode."
                                                : "the owner."}
                            ...
                            >
                                {loggedInAs && node.featured !== undefined ? (
                                    <>
                                        <Dropdown.Item
                                            onClick={() =>
                                                featurePage(node, node.featured)
                                            }
                                            disabled={
                                                loggedInAs.screenName !==
                                                node.owner.screenName
