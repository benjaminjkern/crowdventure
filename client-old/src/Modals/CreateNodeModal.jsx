            ...
            <Form>
                ...
                >
                    ...
                    <div className="row no-gutters">
                        ...
                        <div className="col small text-muted text-center">
                            {!pictureField
                    ...
                    {shouldHide ? (
                        <span style={{ color: "red" }}>
                            The image chosen will cause the page to
                            automatically be hidden. If you would like to not
                            have this happen, change or remove the image.
                        </span>
                    ) : (
                        ""
                    )}
