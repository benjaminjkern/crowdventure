                        ...
                        >
                            <a
                                ...
                                onMouseEnter={() => {
                                    refs[
                                        idx
                                    ].current.style.boxShadow = `0 0 6px ${palette[2]}`;
                                }}
                                onMouseLeave={() => {
                                    refs[
                                        idx
                                    ].current.style.boxShadow = `0 0 3px ${palette[0]}`;
                                }}
                            >
                                <Card.Body
                                    style={{
                            ...
                            {choice.hidden || choice.suggestedBy.hidden ? (
                                <OverlayTrigger
                                    overlay={
                                        <Tooltip>
                                            This action is hidden, because it
                                            has been marked as unsafe! You can
                                            see it because you are{" "}
                                            {loggedInAs && loggedInAs.unsafeMode
                                                ? "in Unsafe Mode."
                                                : "the owner."}
                                        </Tooltip>
                            ...
                            !disabled ? (
                                <OverlayTrigger
                                    overlay={
                                        <Tooltip>
                                            This page this action leads to is
                                            hidden, because it has been marked
                                            as unsafe! You will be able to see
                                            it because you are
                                            {loggedInAs && loggedInAs.unsafeMode
                                                ? "in Unsafe Mode."
                                                : "the owner."}
                            ...
                            >
                                ...
                                <Dropdown.Divider />
                                <Dropdown.Item
                                    onClick={() => reportSuggestion(choice.ID)}
                                >
                                    Report
                                </Dropdown.Item>
                            </DropdownButton>
